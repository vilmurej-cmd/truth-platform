    ...
    setAnalysis({
      ...
      timeline: [
        ...
        })),
        {
          ...
          description: entry.timelineEstimate,
          type: 'milestone',
            ...
            {pipelineStages.map((stage, i) => (
              ...
              >
                ...
                {i < pipelineStages.length - 1 && (
                  <div className="hidden lg:block absolute right-0 top-1/2 -translate-y-1/2 text-text-muted">
                    &rarr;
                  </div>
                )}
              </motion.div>
          ...
          <div className="flex mt-4 rounded-full overflow-hidden h-3">
            {pipelineStages.map((stage) => (
              <motion.div
                key={stage.name}
                initial={{ width: 0 }}
                animate={{ width: `${(stage.count / 116) * 100}%` }}
